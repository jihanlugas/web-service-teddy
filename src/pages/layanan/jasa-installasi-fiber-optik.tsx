...
import { MdComputer, MdOutlineDesignServices, MdCable, MdSettingsSystemDaydream, MdOutlineNetworkCheck } from 'react-icons/md';
...
const JasaInstallasiFiberOptik: React.FC<Props> = () => {
  ...
  return (
    <>
      <Head>
        <title>{process.env.APP_NAME + ' - Jasa Instalasi Fiber Optik'}</title>
      ...
      <div className='bg-neutral-800'>
        <div className='h-96 relative'>
          <Image
            src={'/background/jasa-installasi-fiber-optik.jpg'}
          ...
          <div className='max-w-6xl mx-auto'>
            <div className='absolute h-96 w-full max-w-xl flex flex-col justify-center text-gray-50 p-4'>
              <h1 className='font-bold text-gray-50 my-4'>{'Jasa Instalasi Fiber Optik'}</h1>
              <p className='mt-0 mb-4 md:mb-8 text-justify'>{'Layanan ini berfokus pada kegiatan instalasi, operasi, pemeliharaan dan perbaikan infrastruktur kabel, Pengalaman kami pada penggunaan kabel twisted pair sampai dengan fiber optic akan membantu anda dalam menciptakan media transmisi paling sesuai dengan kebutuhan anda.'}</p>
      ...
      <div className='h-full bg-gray-50'>
        <div className='max-w-6xl mx-auto p-4 py-8 md:py-16'>
          <div className='mb-16'>
            ...
            <p>Ruang lingkup pekerjaan terkait jasa instalasi jaringan menggunakan kabel Fiber Optik</p>
          </div>
      ...
      <div className='h-full bg-gray-50'>
        <div className='max-w-6xl mx-auto p-4'>
          <div className='rounded grid grid-cols-1 md:grid-cols-4 gap-4'>
            <h2 className='my-0'>
              Harga Jasa Instalasi Jaringan Fiber Optik
            </h2>
            <div className='col-span-3'>
              <div className='px-0 md:px-4 mb-8'>
                <div className='block md:flex mb-2 md:mb-0 justify-between text-xl font-bold'>
                  <div>Instalasi Jaringan Fiber Optik</div>
                  <div>Call</div>
                </div>
                <div>
                  Pulling / Tarik kabel dan Krimping ( Harga per titik )
                </div>
              </div>
              <div className='px-0 md:px-4 mb-8'>
                <div className='block md:flex mb-2 md:mb-0 justify-between text-xl font-bold'>
                  <div>Instalasi Dropcore</div>
                  <div>Rp. 250.000,-</div>
                </div>
                <div>
                  Pemasangan dropcre ( Harga per titik )
                </div>
              </div>
              <div className='px-0 md:px-4 mb-8'>
                <div className='block md:flex mb-2 md:mb-0 justify-between text-xl font-bold'>
                  <div>Instalasi Fast Connector FO</div>
                  <div>Rp. 75.000,-</div>
                </div>
                <div>
                  Pasang fast connector saja tanpa tarik kabel ( Harga per titik )
                </div>
              </div>
              <div className='px-0 md:px-4 mb-8'>
                <div className='block md:flex mb-2 md:mb-0 justify-between text-xl font-bold'>
                  <div>Splicing Fiber Optik</div>
                  <div>Rp. 75.000,-</div>
                </div>
                <div>
                  Penyambungan kabel fiber optik ( Harga per titik )
                </div>
              </div>
              <div className='px-0 md:px-4 mb-8'>
                <div>
...
(JasaInstallasiFiberOptik as PageWithLayoutType).layout = Main;

export default JasaInstallasiFiberOptik