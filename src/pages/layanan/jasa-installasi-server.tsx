...
const JasaInstallasiServer: React.FC<Props> = () => {
    ...
    <>
      ...
      <div className='h-full bg-gray-50'>
        <div className='max-w-6xl mx-auto p-4 py-8 md:py-16'>
          <div className='mb-16'>
            ...
            <p>Ruang lingkup pekerjaan terkait Jasa Instalasi Server.</p>
          </div>
        ...
        <div className='max-w-6xl mx-auto p-4'>
          <div className='rounded grid grid-cols-1 md:grid-cols-4 gap-4'>
            ...
            <div className='col-span-3'>
              ...
              <div className='px-0 md:px-4 mb-8'>
                <div className='block md:flex mb-2 md:mb-0 justify-between text-xl font-bold'>
                  <div>Instalasi Active Directory</div>
                  <div>Call</div>
                </div>
              </div>
              <div className='px-0 md:px-4 mb-8'>
                <div className='block md:flex mb-2 md:mb-0 justify-between text-xl font-bold'>
                  <div>Update & Migrasi Server</div>
                  <div>Call</div>
                </div>
              </div>
              <div className='px-0 md:px-4 mb-8'>
                <div className='block md:flex mb-2 md:mb-0 justify-between text-xl font-bold'>
                  <div>Migrasi Data / Database</div>
                  <div>Call</div>
                </div>
              </div>
              <div className='px-0 md:px-4 mb-8'>
      ...
      <div className='h-full bg-gray-50'>
        <div className='max-w-6xl mx-auto p-4'>
          <div className='rounded grid grid-cols-1 md:grid-cols-4 gap-4'>
            <h2 className='my-0'>
              Pertanyaan umum terkait layanan jasa instalasi server
            </h2>
            <div className='col-span-3'>
...
(JasaInstallasiServer as PageWithLayoutType).layout = Main;

export default JasaInstallasiServer;