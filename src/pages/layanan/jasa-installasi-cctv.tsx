...
const JasaInstallasiCctv: React.FC<Props> = () => {
    ...
    <>
        ...
        <div className='h-96 relative'>
          ...
          <div className='max-w-6xl mx-auto'>
            <div className='absolute h-96 w-full max-w-xl flex flex-col justify-center text-gray-50 p-4'>
              <h1 className='font-bold text-gray-50 my-4'>{'Jasa Instalasi CCTV'}</h1>
              <p className='mt-0 mb-4 md:mb-8 text-justify'>{'Layanan ini berfokus pada kegiatan instalasi, operasi, pemeliharaan terkait dengan CCTV.'}</p>
      ...
      <div className='h-full bg-gray-50'>
        <div className='max-w-6xl mx-auto p-4 py-8 md:py-16'>
          <div className='mb-16'>
            ...
            <p>Ruang lingkup pekerjaan terkait Jasa Instalasi CCTV</p>
          </div>
            ...
            <div className='col-span-3'>
              <div className='px-0 md:px-4 mb-8'>
                <div className='block md:flex mb-2 md:mb-0 justify-between text-xl font-bold'>
                  <div>Instalasi CCTV atau IP Cam</div>
                  <div>Rp. 150.000,-</div>
                </div>
                <div>
                  Instalasi dan konfigurasi perangkat CCTV serta perapian ( Harga per titik )
                </div>
              </div>
              <div className='px-0 md:px-4 mb-8'>
                <div className='block md:flex mb-2 md:mb-0 justify-between text-xl font-bold'>
                  <div>Instalasi DVR</div>
                  <div>Rp. 500.000,-</div>
                </div>
                <div>
                  Instalasi dan konfigurasi perangkat DVR ( Harga per unit )
                </div>
              </div>
              <div className='px-0 md:px-4 mb-8'>
                <div>
      ...
      <div className='h-full bg-gray-50'>
        <div className='max-w-6xl mx-auto p-4'>
          <div className='rounded grid grid-cols-1 md:grid-cols-4 gap-4'>
            <h2 className='my-0'>
              Pertanyaan umum terkait layanan jasa instalasi cctv
            </h2>
            <div className='col-span-3'>
...
(JasaInstallasiCctv as PageWithLayoutType).layout = Main;

export default JasaInstallasiCctv;